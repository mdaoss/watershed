...
var Cell = cell.Module(
	"config", // Module identifier (for e.g. logging and tracing)
	"Loads and initializes running config from yaml file", // Module title (for documentation)
	...
	cell.Provide(InitRunningConfig),
)
