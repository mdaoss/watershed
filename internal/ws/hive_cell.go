...
var Cell = cell.Module(
	"watershed", // Module identifier (for e.g. logging and tracing)
	"sync NAT and Conntrack bpf maps between egress gateways", // Module title (for documentation)
	...
	cell.Provide(NewSyncManager),
	cell.Invoke(StartSync),
	//cell.Invoke(InitManagerMetrics),
)
